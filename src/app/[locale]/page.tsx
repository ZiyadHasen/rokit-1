          ...
          <main>
            ...
            <form>
              ...
              <section className="flex w-full mt-10">
                <Link href="/home" className="w-full" role="button">
                  <button
          ...
          {(onClose) => (
            <>
              ...
              <ModalBody className="text-sm sm:text-lg">
                ...
                공지'에 있는 추가 약관에 동의하며, 동 약관은 웹 사이트 페이지의
                우측 하단에 있는 '법적 공지' 링크를 동해 접속할 수 있습니다.
                ROKIT Healthcare, Inc. 2018(달리 언급하는 경우는 예외). 판권
                소유
              </ModalBody>
              <ModalFooter>
                <Button
